...
​
create table ivavprp.resume_vacancy
(
    id         bigint generated by default as identity
        constraint resume_vacancy_pkey
            primary key,
    status     varchar(255),
    resume_id  bigint
        constraint fklhecocj2kvnq81piisdiai82s
            references ivavprp.resume,
    vacancy_id bigint
        constraint fkfui3bc9y4hjyfapmhcii9jdpq
            references ivavprp.vacancy
);

alter table ivavprp.resume_vacancy
    owner to postgres;
